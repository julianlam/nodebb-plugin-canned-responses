...
responses.list = function(uid, options, callback) {
	var method = 'getSortedSetRange',
		sets = 'canned-responses:index:' + uid;
	if (options.all === true) {
		method = 'getSortedSetUnion';
		sets = ['canned-responses:index:' + uid, 'canned-responses:index:0']
	}

	db[method](sets, 0, -1, function(err, responseIds) {
